...
*/   
   ...
   public BoardDTO(int num, String category) {
	super();
	this.num = num;
...
public void setFilesize(String filesize) {
   ...
   public BoardDTO(int num, String title, String content,String category) {
	      super();
	      this.num = num;
	      this.title = title;
	      this.content = content;
   ...
   public BoardDTO(String id, String title, String category, String content) {
      super();
      this.id = id;
      this.title = title;
      this.category = category;
